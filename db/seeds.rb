...
User.create!(name: 'Daniel', username: 'daniel', is_technician: "Sim", user_level: 0, password: '32453245')
User.create!(name: 'Mauricio', username: 'mauricio', is_technician: "Sim", user_level: 0, password: '32453245')
...
User.create!(name: 'Nicolas', username: 'nicolas', is_technician: "Sim", user_level: 0, password: '32453245')
User.create!(name: 'Thiago', username: 'thiago', is_technician: "Sim", user_level: 0, password: '32453245')
User.create!(name: 'Willian', username: 'willian', is_technician: "Sim", user_level: 0, password: '32453245')
